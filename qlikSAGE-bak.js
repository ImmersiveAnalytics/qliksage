...
var qlikSAGE = SAGE2_App.extend( {
    init: function(data) {
        ...
        elem.innerHTML +=
            "<div id='qvobject' style='position:absolute; background:white;width:100%;height:"+(elem.offsetHeight-40)+"px;top:40px'>Loading...</div>";
   ...
   //      if(!qlikLoaded)
    ...
    resize: function(date) {
        ...
        var qlikElem = document.getElementById("qvobject");
        qlikElem.style.height = (sageElem.offsetHeight-40) + "px";
